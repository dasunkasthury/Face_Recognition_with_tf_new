...
face_recognition_model_5.save('face_recognition_model_5_20E_512BS_2700SPE_650VS.h5')

def plot_accuracy(history):
    plt.plot(history.history["acc"], color='red')
    plt.plot(history.history["val_acc"], color='orange')

    plt.title("20E_512BS_2700SPE_650VS_Accuracy")
...
def plot_loss(history):
    ...
    plt.title("20E_512BS_2700SPE_650VS_Loss")
